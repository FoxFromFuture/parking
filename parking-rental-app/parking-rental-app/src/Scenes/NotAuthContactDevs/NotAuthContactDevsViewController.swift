//
//  NotAuthContactDevsViewController.swift
//  parking-rental-app
//
...
// MARK: - NotAuthContactDevsViewController
final class NotAuthContactDevsViewController: UIViewController {
    // MARK: - Constansts
    ...
    private let interactor: NotAuthContactDevsBusinessLogic
    private let router: NotAuthContactDevsRoutingLogic
    ...
    // MARK: - LifeCycle
    init(
        router: NotAuthContactDevsRoutingLogic,
        interactor: NotAuthContactDevsBusinessLogic
    ) {
        self.router = router
    ...
    private func configureGithubButton() {
        ...
        githubButton.pressAction = { [weak self] in
            self?.interactor.loadGitHubLink(NotAuthContactDevsModel.GitHubLink.Request())
        }
    }
...
// MARK: - DisplayLogic
extension NotAuthContactDevsViewController: NotAuthContactDevsDisplayLogic {
